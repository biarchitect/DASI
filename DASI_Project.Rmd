...
The scope of inference on this dataset will be limited to the variables of interest above filtered on only the years of the survey after 2007/2008, that is 2010 and 2012. The dataset is also being limited to only those who are or have been working. All non-responses (NAs) have also been removed. This makes for a nice tidy dataset of 799 observations. The observations have been randomly sampled from less than 10% of the U.S. population. There are more than 30 within each of the variable grooups of interest. Therefore we can do some statistical inference on this data set in order to make some generalized comments about the working U.S. population and only the working population.
...
1. The sampled observations are random and independent of each other [1],[2].
